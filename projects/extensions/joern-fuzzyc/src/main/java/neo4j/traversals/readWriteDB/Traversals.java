...
public class Traversals {
	...
	public static IndexHits<Node> getStatementsForFunction(Node funcNode) {
		String query = String.format("%s:True AND %s:%d", NodeKeys.IS_CFG_NODE, NodeKeys.FUNCTION_ID, funcNode.getId());
	...
	public static List<Node> getCallsTo(String source) {
		...
		String query = String.format("%s:CallExpression AND %s:%s" + "*", NodeKeys.NODE_TYPE, NodeKeys.CODE, source);
	...
	public static List<Node> getCallsToForFunction(String source, long functionId) {
		...
		String query = String.format("%s:CallExpression AND %s:%d AND %s:%s" + "*", NodeKeys.NODE_TYPE,
