...
public class FunctionParserTest extends FunctionParserTestBase {
	...
	public void testIfWithLinebreaksInCondition() {
		...
		assertEquals("(statements (statement (block_starter (selection_or_iteration if ( "
				...
				+ "(equality_operator ==) \\n "
				+ "(equality_expression (relational_expression (shift_expression (additive_expression (multiplicative_expression (cast_expression (function_pointer_use_expression (unary_expression (postfix_expression (primary_expression (identifier bar))))))))))))))))))))) )))) "
